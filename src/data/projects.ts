...
export const SELECTED_PROJECTS: SelectedProject[] = [
  {
    ...
    description:
      "A browser-based graphic design application for creating certificates, resumes, social media graphics, and marketing assets. Built on a direct-manipulation canvas engine with custom object transformations, layer management, undo/redo history, and client-side raster/vector export.",
    capabilities: [
  ...
  },
  {
    ...
    description:
      "A production donation platform serving donors worldwide across emergency relief, education, and healthcare campaigns. Custom multi-currency checkout flows, automated recurring monthly contributions via Stripe, and verified donor reporting.",
    metric: {
      value: "£43,000+",
